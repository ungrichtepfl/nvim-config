...
vim.o.updatetime = 60 -- default is 4000ms (4 seconds), so lower is much snappier (triggers Curserhold)
vim.o.timeoutlen = 300 -- Wait milliseconds for mapped secence to complete
