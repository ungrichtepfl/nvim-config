...
vim.keymap.set("n", "K", function() vim.lsp.buf.hover { border = "rounded" } end, { desc = "Show hover information" })
vim.keymap.set("n", "grc", function() vim.lsp.codelens.run() end, {
  desc = "Run codelens actions",
})
vim.keymap.set("n", "gD", function() vim.lsp.buf.declarations() end, { desc = "Go to declaration" })
vim.keymap.set("n", "gd", function() vim.lsp.buf.definitions() end, { desc = "Go to definition" })
