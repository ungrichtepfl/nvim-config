...
local function lsp_keymaps(bufnr)
  local function opts(desc) return { noremap = true, silent = true, buffer = bufnr, desc = "Lsp: " .. desc } end
  ...
  vim.keymap.set("n", "gl", '<cmd>lua vim.diagnostic.open_float({ border = "rounded" })<CR>', opts "Show diagnostics")
  vim.keymap.set(
    "n",
    "]d",
